        ...
        {userData ? (
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="w-full bg-gray-50 p-4 rounded-lg shadow-inner mb-6">
              <h3 className="text-lg font-medium text-gray-700 mb-2">About</h3>
              <p className="text-gray-600">
                Passionate about crafting interactive and responsive web
                applications using modern web technologies. Experienced with
            ...
            <div className="w-full bg-gray-50 p-4 rounded-lg shadow-inner mb-6">
              ...
              <p className="text-gray-600">
                JavaScript, React, Next.js, Tailwind CSS, TypeScript
              </p>
            </div>
